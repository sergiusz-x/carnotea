...
CREATE INDEX idx_charging_sessions_charge_date ON charging_sessions(charge_date);
...
CREATE INDEX idx_part_identifiers_lookup
    ON part_identifiers(identifier_type_id, source_name, identifier_value);
...
CREATE INDEX idx_reminders_status_id ON reminders(status_id);
...
CREATE INDEX idx_reminders_status_due ON reminders(status_id, due_date);
