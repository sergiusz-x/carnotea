...
| TypeScript  | Strict types everywhere                          | `tsconfig.base.json` + `tooling/typescript` |
| ESLint      | Linting                                          | `tooling/eslint` (T-001) |
| Prettier    | Formatting                                       | `tooling/prettier` (T-001) |
| sherif      | Workspace dependency-consistency linter          | `pnpm lint:ws`, runs on postinstall |
