...
async function main() {
  ...
  const fuelEntries: Array<{
    ...
    { fuelDate: '2026-01-05', mileage: 81200, liters: 48.2, ppl: 6.89, station: 'Orlen', full: true },
    { fuelDate: '2026-01-20', mileage: 81870, liters: 12.5, ppl: 6.91, station: 'BP', full: false },
    { fuelDate: '2026-02-03', mileage: 82620, liters: 46.8, ppl: 6.95, station: 'Shell', full: true },
    { fuelDate: '2026-02-22', mileage: 83410, liters: 47.5, ppl: 6.88, station: 'Lotos', full: true },
    { fuelDate: '2026-03-08', mileage: 84150, liters: 44.3, ppl: 6.99, station: 'Orlen', full: true },
    { fuelDate: '2026-03-25', mileage: 84890, liters: 18.0, ppl: 7.02, station: 'Neste', full: false },
    { fuelDate: '2026-04-07', mileage: 85580, liters: 46.1, ppl: 7.05, station: 'Orlen', full: true },
    { fuelDate: '2026-04-23', mileage: 86150, liters: 45.9, ppl: 6.98, station: 'BP', full: true },
    { fuelDate: '2026-05-09', mileage: 86870, liters: 44.7, ppl: 6.92, station: 'Shell', full: true },
    { fuelDate: '2026-05-28', mileage: 87500, liters: 43.8, ppl: 6.85, station: 'Orlen', full: true },
  ];
  ...
  const chargingEntries: Array<{
    ...
    { chargeDate: '2026-01-04', mileage: 38200, kwh: 55.0, pkwh: 0.82, charger: 'home_socket', socStart: 18, socEnd: 90, station: null, full: false },
    { chargeDate: '2026-01-18', mileage: 38850, kwh: 35.5, pkwh: 0.82, charger: 'home_socket', socStart: 30, socEnd: 74, station: null, full: false },
    { chargeDate: '2026-02-02', mileage: 39400, kwh: 60.2, pkwh: 1.29, charger: 'dc_ccs', socStart: 15, socEnd: 80, station: 'Greenway Kraków', full: false },
    { chargeDate: '2026-02-20', mileage: 39980, kwh: 48.0, pkwh: 0.82, charger: 'home_socket', socStart: 22, socEnd: 81, station: null, full: false },
    { chargeDate: '2026-03-06', mileage: 40500, kwh: 63.8, pkwh: 0.82, charger: 'home_socket', socStart: 10, socEnd: 95, station: null, full: true },
    { chargeDate: '2026-03-22', mileage: 41050, kwh: 40.1, pkwh: 1.45, charger: 'dc_ccs', socStart: 20, socEnd: 72, station: 'Ionity A4', full: false },
    { chargeDate: '2026-04-05', mileage: 41600, kwh: 52.3, pkwh: 0.82, charger: 'home_socket', socStart: 15, socEnd: 85, station: null, full: false },
    { chargeDate: '2026-04-22', mileage: 42050, kwh: 57.9, pkwh: 0.82, charger: 'home_socket', socStart: 12, socEnd: 89, station: null, full: false },
    { chargeDate: '2026-05-10', mileage: 42300, kwh: 45.6, pkwh: 1.39, charger: 'ac_type2', socStart: 25, socEnd: 80, station: 'Orlen Charge', full: false },
  ];
  ...
  await db.insert(schema.issues).values([
    {
      ...
      description: 'Przy zwalnianiu słyszalny pisk z prawego przedniego koła, głównie przy zimnym starcie.',
    ...
    },
    {
      ...
      description: 'Przednie opony zużywają się szybciej po wewnętrznej stronie. Zbieżność sprawdzona — w normie.',
