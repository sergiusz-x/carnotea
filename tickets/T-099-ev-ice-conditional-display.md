...
owner: antigravity
dependencies: []
created_at: 2026-07-21T17:41:00Z
...
- [x] UI components displaying vehicle stats (e.g., Dashboard, Vehicle Panel, Quick Add) conditionally render based on the vehicle's powertrain type (EV vs ICE).
- [x] Average fuel consumption is hidden for EVs.
- [x] Battery charge/charging sessions are hidden for ICE vehicles.
- [x] All forms accurately reflect the correct fields based on vehicle type.
